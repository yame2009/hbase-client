...
/**
 * Class Name: MopStarterPlugin Create Date: 18-3-21 下午3:15 Creator: Chim·Zigui
 * Version: v1.0 Updater: Date Time: Description:
 */
public class MopHbaseStarterListener {
	...
	public void onFinished(ApplicationContext context) {
		...
		if (hBaseConfig != null) {
			...
			initInformation.put("zookeeper-port",
					StringUtils.isBlank(hBaseConfig.getZookeeperClientPort()) ? HBaseConstant.DEFAULT_HBASE_PORT : hBaseConfig.getZookeeperClientPort());
		}
	}
}
