...
import com.tool.hbase.utils.HBaseAssistUtil;
import com.tool.hbase.utils.JacksonUtil;
...
public class HBaseDaoImpl implements HBaseDao {
	...
	@Override
	public List<String> getRowKeys(String namespace, String tableName, String startRow, String endRow, Integer pageSize, String separate, Integer index) throws Exception {
	...
	public List<ColumnInfo> getColumnsByPage(String namespace, String tableName, String rowkey, Integer pageNo, Integer pageSize, List<ColumnInfo> columns,
			List<ColumnInfo> filters) throws Exception {
		HTable hTable = null;
		List<ColumnInfo> dataList = new ArrayList<>();
		try {
			hTable = hBaseDdlDao.getTable(namespace, tableName);
	...
	public boolean put(String namespace, String tableName, String rowKey, List<ColumnInfo> columnInfos, Long timestamp) throws Exception {
		...
		try {
			...
			for (ColumnInfo columnInfo : columnInfos) {
				if (timestamp == null) {
					put.add(columnInfo.getColumnFamily().getBytes(), columnInfo.getColumn().getBytes(),
